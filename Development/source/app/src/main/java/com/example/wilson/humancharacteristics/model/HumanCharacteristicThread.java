...
public class HumanCharacteristicThread extends BaseHumanCharacteristic {
    private Classifier classifier;
    private static final String MODEL = "file:///android_asset/thread.model.pb";
    private static final String Label= "file:///android_asset/labels.txt";
    private boolean activeMode;
    public HumanCharacteristicThread(final  AssetManager assetManager) {
